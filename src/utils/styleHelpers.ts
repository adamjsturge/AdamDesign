    ...
    switch (style) {
        ...
        case "elevated":
            return {
                ...base,
                backgroundColor: "var(--preview-bg-surface)",
                boxShadow: shadow !== "none" ? "var(--preview-shadow)" : "0 4px 6px -1px rgb(0 0 0 / 0.1)",
            };
        case "transparent":
            return {
                ...base,
...
export function getBadgeStyles(
    ...
    const colors = {
        ...
        neutral: {
            ...
            subtle: "color-mix(in srgb, var(--preview-text-secondary) 15%, transparent)",
        },
    };
...
export function getFocusStyles(style: string): React.CSSProperties {
    switch (style) {
        ...
        case "glow":
            return {
                outline: "none",
                boxShadow: "0 0 0 3px color-mix(in srgb, var(--preview-accent) 50%, transparent)",
            };
        case "border":
            return {
                outline: "none",
